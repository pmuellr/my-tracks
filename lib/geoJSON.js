...
function fixFeature(feature) {
  ...
  var dateEnd   = new Date(coordTimes[coordTimes.length-1])
  var elapsed   = dateEnd.getTime() - dateStart.getTime()
  ...
  feature.properties.altUp         = altUp
  feature.properties.altDown       = altDown
